	...
	; -I./inc -I./app -I./external -I./external/printf \
	; build/obj/app/main.p1 build/obj/app/app.p1 build/obj/src/gpio.p1 \
	; build/obj/src/buffer.p1 build/obj/src/uart.p1 build/obj/src/timer0.p1 \
	; build/obj/src/isr.p1 build/obj/src/system_tick.p1 \
	; build/obj/src/clock.p1 build/obj/src/button_driver.p1 \
	; build/obj/src/ss_display.p1 build/obj/src/eeprom.p1 \
	; build/obj/app/clock_storage.p1 build/obj/external/printf/printf.p1 \
	; -oclock --objdir=build/bin --outdir=build/bin -L--fixupoverflow=error \
